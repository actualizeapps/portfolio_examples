...
class DatabaseManager {
    ...
    async getTopScoreFromLeaderboardServer() {
        try {
            const response = await fetch(`${this.serverUrl}/get_leaderboard`);
            if (response.ok) {
    ...
    async getLeaderboardFromServer(shouldUpdateDisplay = true) {
        ...
        try {
            ...
            const response = await fetch(`${this.serverUrl}/get_leaderboard?${endDateString}`);
            if (response.ok) {
    ...
    async insertLeaderboardEntry(name, score, gameType, dataStructure, shouldUpdateDisplay = true) {
        ...
        try {
            const response = await fetch(`${this.serverUrl}/insert_leaderboard_entry`, {
                method: 'POST',
                headers: {
